...
class Libro(models.Model):
    ...
    idioma = models.ForeignKey('Idioma', on_delete=models.SET('NULL'), null=True, blank=True)
    genero = models.ForeignKey('Genero', on_delete=models.SET('NULL'), null=True, blank=True)
